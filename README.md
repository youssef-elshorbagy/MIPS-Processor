...
The full project report — covering VHDL background, design rationale, RTL schematics for every block, controller function tables, and simulation waveforms for the Register File, ALU, and full processor — is available separately as the project PDF (`COA_Major_Task.pdf` / "Building a Processor" report).
